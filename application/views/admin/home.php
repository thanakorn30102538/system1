...
if(!$user_status ==['Admin'] && !$user_id){
 
  redirect('');
}elseif($user_id && !$user_status ==['Admin']){
    redirect(''); 
}
?>
<!doctype html>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">ผู้ใช้งาน</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>ข้อมูลผู้ใช้งาน</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="<?php echo site_url("index.php/ad/manage_user"); ?>">จัดการข้อมูลผู้ใช้งาน</a></li>
