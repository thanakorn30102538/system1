...
<head>
    ...
    <title>Softwar Engineering Project Management System</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        <a href="home"> <i class="menu-icon fa fa-dashboard"></i>หน้าหลัก </a>
                    </li>
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-flag"></i>องค์ความรู้</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="<?php echo site_url("index.php/stu/show_project"); ?>">ปริญญานิพนธ์</a></li>
                ...
                <div class="col-sm-12">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                                <a class="nav-link" href="<?php echo site_url("index.php/stu/profile"); ?>"><i class="fa fa- user"></i>My Profile</a>
                                <a class="nav-link" href="<?php echo site_url("index.php/stu/logout"); ?>"><i class="fa fa-power -off"></i>Logout</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div id="pay-invoice">
                                <div class="card-body">
                                    <div class="card-title">
                                      <h3 class="text-center">ยินดีต้อนรับค่ะ คุณ <?php echo $this->session->userdata('name');  ?></h3>
                                    </div>
                                    <hr>
                                    <form action="" method="post" novalidate="novalidate">
                                        <div class="form-group">
                                            <a href="<?php echo site_url("index.php/stu/show_project"); ?>"><h5 class="text-center">ค้นคว้าข้อมูลปริญญานิพนธ์ทันที</h5></a>
                                        </div>
                                        <div class="form-group">
                                            <a href="<?php echo site_url("index.php/stu/show_news"); ?>"><h5 class="text-center">อ่านข่าวประชาสัมพันธ์ทันที</h5></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
