                            ...
                            <div id="pay-invoice">
                                <div class="card-body">
                                    <div class="card-title">
                                      <h3 class="text-center">ยินดีต้อนรับค่ะ อาจารย์<?php echo $this->session->userdata('name');  ?></h3>
                                    </div>
                                    <hr>
                                    <form action="" method="post" novalidate="novalidate">
                                        <div class="form-group">
                                            <a href="<?php echo site_url("index.php/lec/manage_project"); ?>"><h5 class="text-center">จัดการข้อมูลปริญญานิพนธ์</h5></a>
                                        </div>
                                        <div class="form-group">
                                            <a href="<?php echo site_url("index.php/lec/manage_news"); ?>"><h5 class="text-center">จัดการข้อมูลข่าวประชาสัมพันธ์</h5></a>
                                        </div>
                                    </form>
                                </div>
                            </div>
