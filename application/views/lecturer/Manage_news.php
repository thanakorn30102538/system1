            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <a href="<?php echo site_url("index.php/lec/add_news"); ?>" class="btn btn-success">เพิ่ม</a>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <?php foreach($news as $n){ ?>
                        <tr>
                            ...
                            <td>                 
                            <a href="<?php echo site_url("index.php/lec/edit_news".$n['news_id']); ?>" class="btn btn-info btn-xs">แก้ไข</a>
                            <a href="<?php echo site_url("index.php/lec/delete_news/".$n['news_id']); ?>" class="btn btn-danger btn-xs">ลบ</a>
