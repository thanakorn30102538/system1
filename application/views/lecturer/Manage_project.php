            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-flag"></i>องค์ความรู้</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="">ปริญญานิพนธ์</a></li>
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <a href="<?php echo site_url("index.php/lec/add_project"); ?>" class="btn btn-success">เพิ่ม</a>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <?php foreach($project as $p){ ?>
                        <tr>
                            ...
                            <td>                 
                            <a href="<?php echo site_url("index.php/lec/edit_project/".$p['project_id']); ?>" class="btn btn-info btn-xs">แก้ไข</a>
                            <a href="<?php echo site_url("index.php/lec/delete_project/".$p['project_id']); ?>" class="btn btn-danger btn-xs">ลบ</a>
